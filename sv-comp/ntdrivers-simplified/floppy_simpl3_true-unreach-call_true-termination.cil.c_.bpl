...
$bb0:
  call {:cexpr "DeviceObject"} boogie_si_record_int(DeviceObject);
  call {:cexpr "Irp"} boogie_si_record_int(Irp);
  assume {:sourceloc "floppy_simpl3.cil.c", 1157, 3} true;
  $M.18 := 0;
  ...
  assume {:sourceloc "floppy_simpl3.cil.c", 1160, 3} true;
  call IofCompleteRequest(Irp, 0);
  assume {:sourceloc "floppy_simpl3.cil.c", 1162, 3} true;
  $r := 0;
  $exn := false;
  return;
}
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "floppy_simpl3.cil.c", 971, 15} true;
  call $p5 := __VERIFIER_nondet_int();
  call {:cexpr "tmp_ndt_7"} boogie_si_record_int($p5);
...
$bb7:
  ...
  call $p7 := __VERIFIER_nondet_int();
  call {:cexpr "tmp_ndt_8"} boogie_si_record_int($p7);
...
$bb3:
  ...
  call $p13 := __VERIFIER_nondet_int();
  call {:cexpr "tmp_ndt_9"} boogie_si_record_int($p13);
...
$bb0:
  ...
  assume {:sourceloc "floppy_simpl3.cil.c", 1092, 16} true;
  call $p0 := __VERIFIER_nondet_int();
...
$bb0:
  ...
  call $p0 := __VERIFIER_nondet_int();
  call {:cexpr "tmp_ndt_12"} boogie_si_record_int($p0);
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20, $M.21, $M.22, $M.23, $M.24, $M.25, $M.26, $M.27;
{
  var $p0: int;
$bb0:
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 73, 3} true;
  $M.2 := 0;
  call {:cexpr "UNLOADED"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 74, 3} true;
  $M.3 := 1;
  call {:cexpr "NP"} boogie_si_record_int(1);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 75, 3} true;
  $M.4 := 2;
  call {:cexpr "DC"} boogie_si_record_int(2);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 76, 3} true;
  $M.5 := 3;
  call {:cexpr "SKIP1"} boogie_si_record_int(3);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 77, 3} true;
  $M.6 := 4;
  call {:cexpr "SKIP2"} boogie_si_record_int(4);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 78, 3} true;
  $M.7 := 5;
  call {:cexpr "MPR1"} boogie_si_record_int(5);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 79, 3} true;
  $M.8 := 6;
  call {:cexpr "MPR3"} boogie_si_record_int(6);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 80, 3} true;
  $M.9 := 7;
  call {:cexpr "IPC"} boogie_si_record_int(7);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 81, 3} true;
  $p0 := $M.2;
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 81, 3} true;
  $M.10 := $p0;
  call {:cexpr "s"} boogie_si_record_int($p0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 82, 3} true;
  $M.11 := 0;
  call {:cexpr "pended"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 83, 3} true;
  $M.12 := 0;
  call {:cexpr "compRegistered"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 84, 3} true;
  $M.13 := 0;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 85, 3} true;
  $M.14 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 86, 3} true;
  $M.15 := 0;
  call {:cexpr "customIrp"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 89, 1} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 38, 10} true;
  call __VERIFIER_error();
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/floppy_simpl3_true-unreach-call_true-termination.cil.c_.c", 41, 1} true;
  $exn := false;
  return;
}

  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2, $M.3, $M.4, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $M.14, $M.15, $M.16, $M.17, $M.18, $M.19, $M.20;
{
  var $p0: int;
$bb0:
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 52, 3} true;
  $p0 := $M.2;
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 52, 3} true;
  $M.3 := $p0;
  call {:cexpr "s"} boogie_si_record_int($p0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 53, 3} true;
  $M.4 := 0;
  call {:cexpr "pended"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 54, 3} true;
  $M.5 := 0;
  call {:cexpr "compFptr"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 55, 3} true;
  $M.6 := 0;
  call {:cexpr "compRegistered"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 56, 3} true;
  $M.7 := 0;
  call {:cexpr "lowerDriverReturn"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 57, 3} true;
  $M.8 := 0;
  call {:cexpr "setEventCalled"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 58, 3} true;
  $M.9 := 0;
  call {:cexpr "customIrp"} boogie_si_record_int(0);
  assume {:sourceloc "/mnt/local/svcomp/results/ControlFlowInteger_1417798727.29_FINALCREATE/files/CBC_ntdrivers-simplified/kbfiltr_simpl2_true-unreach-call_true-termination.cil.c_.c", 61, 1} true;
  $exn := false;
  return;
}

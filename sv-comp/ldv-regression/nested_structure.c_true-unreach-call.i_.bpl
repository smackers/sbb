...
$bb0:
  ...
  assume true;
  assume {:sourceloc "files/nested_structure.c", 20, 2} true;
  $p3 := $p0;
  assume {:sourceloc "files/nested_structure.c", 20, 2} true;
  call $memcpy.2.2($p3, main.im, 4, 4, false);
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "files/nested_structure.c", 21, 2} true;
  $p4 := $pa($pa($p1, 0, 8), 0, 1);
  assume {:sourceloc "files/nested_structure.c", 21, 2} true;
  $M.3[$p4] := 2;
  assume {:sourceloc "files/nested_structure.c", 21, 2} true;
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "files/nested_structure.c", 22, 2} true;
  $p6 := $pa($pa($p2, 0, 8), 0, 1);
  assume {:sourceloc "files/nested_structure.c", 22, 2} true;
  $M.4[$p6] := 1;
  assume {:sourceloc "files/nested_structure.c", 22, 2} true;
  ...
  assume {:sourceloc "files/nested_structure.c", 22, 2} true;
  $M.4[$p7] := $p1;
  assume {:sourceloc "files/nested_structure.c", 23, 2} true;
  $p8 := $pa($pa($p2, 0, 8), 4, 1);
  assume {:sourceloc "files/nested_structure.c", 23, 2} true;
  $p9 := $M.4[$p8];
  assume {:sourceloc "files/nested_structure.c", 23, 2} true;
  ...
  assume {:sourceloc "files/nested_structure.c", 23, 2} true;
  $M.2[$p12] := 4;
  assume {:sourceloc "files/nested_structure.c", 24, 2} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "files/nested_structure.c", 25, 2} true;
  $r := 0;
  $exn := false;
  return;
$bb3:
  assume !($b19);
  assume {:sourceloc "files/nested_structure.c", 24, 31} true;
  call __blast_assert();
  assume {:sourceloc "files/nested_structure.c", 24, 31} true;
  goto $bb2;
}

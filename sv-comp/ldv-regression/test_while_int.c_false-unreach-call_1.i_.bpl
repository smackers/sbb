...
$bb0:
  ...
  assume {:sourceloc "files/test_while_int.c", 19, 9} true;
  $p0 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "files/test_while_int.c", 19, 9} true;
...
$bb2:
  assume $b1;
  assume {:sourceloc "files/test_while_int.c", 20, 17} true;
  $p2 := $add($p0, 1);
  call {:cexpr "i"} boogie_si_record_int($p2);
  assume {:sourceloc "files/test_while_int.c", 22, 17} true;
  $b3 := ($p2 != 3);
  assume {:sourceloc "files/test_while_int.c", 22, 17} true;
  $p0 := $p2;
  goto $bb4, $bb5;
$bb3:
  assume !($b1);
  assume {:sourceloc "files/test_while_int.c", 27, 2} true;
  $r := 0;
  $exn := false;
  return;
$bb4:
...
$bb5:
  assume !($b3);
  assume {:sourceloc "files/test_while_int.c", 22, 33} true;
  call __blast_assert();
  assume {:sourceloc "files/test_while_int.c", 22, 33} true;
  $p0 := $p2;
  goto $bb1;

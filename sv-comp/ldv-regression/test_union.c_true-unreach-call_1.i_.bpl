...
$bb0:
  ...
  assume true;
  assume {:sourceloc "files/test_union.c", 19, 2} true;
  $p1 := $p0;
  assume {:sourceloc "files/test_union.c", 19, 2} true;
  $M.2[$p1] := 0;
  assume {:sourceloc "files/test_union.c", 21, 2} true;
  $p2 := $p0;
  assume {:sourceloc "files/test_union.c", 21, 2} true;
  $p3 := $M.2[$p2];
  assume {:sourceloc "files/test_union.c", 21, 2} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "files/test_union.c", 25, 1} true;
  $r := 0;
  $exn := false;
  return;
$bb3:
  assume !($b4);
  assume {:sourceloc "files/test_union.c", 21, 23} true;
  call __blast_assert();
  assume {:sourceloc "files/test_union.c", 21, 23} true;
  goto $bb2;
}

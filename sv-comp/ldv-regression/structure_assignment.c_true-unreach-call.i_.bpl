...
$bb0:
  ...
  assume true;
  assume {:sourceloc "files/structure_assignment.c", 15, 2} true;
  $p2 := $p0;
  assume {:sourceloc "files/structure_assignment.c", 15, 2} true;
  call $memcpy.2.2($p2, main.good, 8, 4, false);
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "files/structure_assignment.c", 17, 2} true;
  $p3 := $p1;
  assume {:sourceloc "files/structure_assignment.c", 17, 2} true;
  $p4 := $p0;
  assume {:sourceloc "files/structure_assignment.c", 17, 2} true;
  call $memcpy.2.2($p3, $p4, 8, 4, false);
  assume {:sourceloc "files/structure_assignment.c", 18, 2} true;
  $p5 := $pa($pa($p1, 0, 8), 4, 1);
  assume {:sourceloc "files/structure_assignment.c", 18, 2} true;
  $p6 := $M.2[$p5];
  assume {:sourceloc "files/structure_assignment.c", 18, 2} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "files/structure_assignment.c", 19, 2} true;
  $r := 0;
  $exn := false;
  return;
$bb3:
  assume !($b7);
  assume {:sourceloc "files/structure_assignment.c", 18, 24} true;
  call __blast_assert();
  assume {:sourceloc "files/structure_assignment.c", 18, 24} true;
  goto $bb2;
}
axiom (__SMACK_nondet.XXX == -34);
axiom (main.good == -5079);
axiom $NULL == 0;
axiom $and(0,0) == 0;
axiom $and(0,1) == 0;
axiom $and(1,0) == 0;
